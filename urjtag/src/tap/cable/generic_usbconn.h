...
#define URJ_DECLARE_USBCONN_CABLE(vid, pid, driver, name, cable, desc, interface) \
const urj_usbconn_cable_t urj_tap_cable_usbconn_##cable = { name, desc, driver, vid, pid, interface, 0 };
